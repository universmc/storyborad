...
async function compileSCSS() {
  return new Promise((resolve, reject) => {
    exec('npm run compileSCSS', (error, stdout, stderr) => {
      ...
      console.log(`Compi lation SCSS réussie : ${stdout}`);
      resolve();
    });
  });
}
  ...
  "tasks": [
    {
      ...
      "steps": [
        "Organiser les fichiers de projet (Electron, Pi-Wallet, CVUN, Match in Learning).",
    ...
    {
      "phase": "Phase 2: Travaux sur Pi-Wallet",
      "location": "Open Space",
      "time_start": "2024-10-15T05:00:00",
      "time_end": "2024-10-15T07:00:00",
      "description": "Développement et optimisation du projet Pi-Wallet pour monétiser les compétences via des Smart Contracts.",
      "steps": [
        ...
        "Rédiger la documentation pour les utilisateurs du Pi-Wallet."
      ],
      "status": "En cours",
      "progress": "10%"
    },
    ...
    {
      "phase": "Phase 6: Documentation et finalisation",
      "location": "Open Space",
      ...
      "steps": [
        "Rédiger la documentation utilisateur pour Pi-Wallet et CVUN.",
    ...
    {
      "phase": "Phase 7: Récapitulatif et planification des étapes suivantes",
      "location": "Open Space",
      ...
      "steps": [
        ...
        "Planifier les étapes suivantes pour chaque projet (CVUN, Pi-Wallet, Match in Learning).",
